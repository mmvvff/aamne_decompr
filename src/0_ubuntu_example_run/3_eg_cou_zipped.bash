...
[ -f R_aamne_decompr_cou.tar.gz ] && sudo rm R_aamne_decompr_cou.tar.gz
...
tar cf - ~/r_aamne_wwz/2_pipeline/R_aamne_decompr_cou | pigz -9 -p $cores > R_aamne_decompr_cou.tar.gz

# Check if the compressed file exists and has content
if [ -s R_aamne_decompr_cou.tar.gz ]; then
